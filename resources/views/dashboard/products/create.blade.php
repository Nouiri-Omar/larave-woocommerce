                ...
                <!-- <div class="form-group row">
                    ...
                    <div class="form-group">
                        <!--  <label for="customFile">
                             <a class="btn btn-falcon-info ml-2"> <span class="fas fa-upload"></span></a>
                             <div class="avatar avatar-2xl">
                                 <img class="img-fluid rounded-circle mt-2" id="output" src="" width="32" height="32" alt="">
                             </div>
                         </label>
                         <input class="custom-file" type="file" id="customFile" name="product_Icon" accept="image/*" onchange="document.getElementById('output').src = window.URL.createObjectURL(this.files[0])" style="display: none">
                 </div>-->
                     <br><br>
                     <div class="form-group">
